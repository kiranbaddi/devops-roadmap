...
DevOps is a set of practices, processes and tools that aims to remove the silos between development and operations for faster and quality software delivery. The idea is to apply Software development principles to the Operations as well. Theoretically, Devops is a culture that the entire software engineering team adopts, however, in 
practice DevOps is seen as a job role that is responsible to handle non-development part of the Software Development lifecycle such as Infrastructure deployments, CI-CD, backup and restores, automating administrative and repititve tasks, monitoring and alerting. 

Read also Site Reliability Engineering

## What does a DevOps Engineer Do?

The roles and responsibilities of a DevOps Engineer are quite diverse and vary from organization to organization and in large organizations varies from one business unit to the other. As said earlier, a DevOps engineer typically handles all non development related work. 
This includes:

To put it bluntly a DevOps Engineer has to manage computers and install software that runs the software developed by the software engineering teams. 
...
Once you read what a devops engineer do understand that if you want to become a DevOps engineer you have to be good with computers and how to do it in a smart and non-repitive way. 
One way to differentiate - classic Operations/Sys Admin roles and DevOps Engineers is how much of the work you do it in a smart way - meaning automated and repeatable way with less scope for human errors.
This means one should be really good with command line particularly Linux because most software applications and automations (CI-CD for instance) are run on Linux operating systems.
This also means that one should learn a set of tools which could be configured in Yaml such as Kubernetes, Ansible, GitHub Actions etc or their own Domain Specific Language (DSL) such as Terraform, Dockerfile etc.
No matter, what kind of organization you work for and wha their tech stak is, You will have to write code. You don't have to be a developer while it doesn't hurt to be a good programmer to become a DevOps Engineer but you don't have to be one. 
